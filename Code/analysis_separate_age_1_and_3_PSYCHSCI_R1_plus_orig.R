...
### *** CHANGE THIS TO POINT TO THE LOCATION OF THE FILES ON YOUR COMPUTER *** ###
### *** (OTHERWISE THIS CODE WILL NOT WORK) ***  ###
### *** Windows users: replace "\" with "/" or "\\"; R sees "\" as an escape character *** ###

# root project directory
path <-  "/Users/matt/OneDrive/NLSY-79" 
#path <- "D:/OneDrive/NLSY-79"

NLSY.path <- paste(path, "/Propensity/NLSY_propensity", sep="")
NLSY.cya.path <- paste(path, "/Propensity/NLSY_cya_propensity", sep="")
...
# /Users/matt/OneDrive/NLSY-79/Propensity/NLSY_cya_propensity/NLSY_cya_propensity.R
...
#
# In these R scripts, two things must be changed-
#   1) The setwd() command near the top must be edited to point to the directory on your 
#       computer where the files are located.
#   2) The line reading "categories <- vallabels(new_data)" at the bottom must be
#       uncommented. Found on lines 933 / 5726 in the NLSY and NLSY_cya files, respectively.
#       (otherwise the "factors" versions of these datasets will not be created)
# 
